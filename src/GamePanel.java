...
//TODO:
 //   1. gameover text to appear.
  //  2. checkapple to work.
   // 3.     
    ...
    public void draw(Graphics g) {
        if(running) {
            ...
            g.setColor(new Color(random.nextInt(2), random.nextInt(2), random.nextInt(2), random.nextInt(2)));
